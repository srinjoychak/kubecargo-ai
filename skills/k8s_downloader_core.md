...
| `containerd.io`| Docker | `.el{{ALMA_MAJOR}}.{{ARCH_RPM}}.rpm` |
...
- **Checksum Fail:** Mirror might be out of sync. Retry or skip with `--skip-checksums`.
